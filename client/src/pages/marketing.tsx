        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="space-y-6">
            ...
            <div className="mb-8 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
              ...
              <Card>
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                  <CardTitle className="text-sm font-medium">إجمالي الانطباعات</CardTitle>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">${socialStats.spend.toLocaleString()}</div>
                </CardContent>
              </Card>
            </div>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>قائمة بجميع الحملات الإعلانية النشطة حالياً</CardDescription>
              </CardHeader>
              <CardContent>
