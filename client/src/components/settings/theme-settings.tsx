      ...
      <CardContent className="pb-8">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          <TabsList className="mb-8 grid w-full grid-cols-2 gap-2 md:grid-cols-4">
            {[
              { value: 'theme', icon: <Palette className="h-4 w-4" />, label: 'الألوان' },
              { value: 'font', icon: <Type className="h-4 w-4" />, label: 'الخطوط' },
              { value: 'size', icon: <Plus className="h-4 w-4" />, label: 'الحجم' },
              { value: 'appearance', icon: <Sun className="h-4 w-4" />, label: 'السطوع' },
            ].map(tab => (
              <TabsTrigger
                key={tab.value}
                value={tab.value}
                ...
                {fonts.map(font => (
                  ...
                  >
                    ...
                    >
                      ...
                      <CardContent className="p-4 pt-0">
                        <p className="text-xl leading-relaxed" style={{ fontFamily: font.family }}>
                          {font.preview}
                        </p>
                      </CardContent>
                    </Card>
                    ...
                    <div className="space-y-4">
                      ...
                      >
                        ...
                        <p className="leading-relaxed">
                          هذا نص تجريبي لمعاينة حجم الخط المختار. يمكنك رؤية كيف سيظهر النص في مختلف
                          العناصر.
                        </p>
                      </div>
                    </div>
                    ...
                    >
                      <CardHeader className="p-4">
                        <div className="flex items-center justify-between">
                          ...
                          {appearance === mode.id && <Check className="h-5 w-5 text-primary" />}
                        </div>
                      </CardHeader>
                      <CardContent className="p-4 pt-0">
