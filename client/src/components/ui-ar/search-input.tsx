    ...
    return (
      ...
      >
        <div className="relative flex-1">
          ...
          />
          <div
            className={cn('absolute top-0 flex h-full items-center', rtl ? 'left-3' : 'right-3')}
          >
        ...
        {suggestions && suggestions.length > 0 && searchValue && (
          <div
            className={cn(
              'absolute top-full z-50 mt-1 w-full rounded-md border border-border bg-popover text-popover-foreground shadow-md',
              rtl ? 'right-0' : 'left-0'
            )}
          >
            <ul className="py-2">
