...
import { SiFacebook, SiInstagram, SiX, SiLinkedin, SiSnapchat, SiTiktok } from 'react-icons/si';
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>قم بتسجيل الدخول إلى حساباتك على منصات التواصل الاجتماعي</CardDescription>
      </CardHeader>
      <CardContent>
